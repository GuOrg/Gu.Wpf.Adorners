namespace Gu.Wpf.Adorners
{
    ...
    public static class UnLoaded
    {
        ...
        {
            (d as FrameworkElement)?.AddHandler(FrameworkElement.UnloadedEvent, EmptyRoutedEventHandler);
            (d as FrameworkContentElement)?.AddHandler(FrameworkContentElement.UnloadedEvent, EmptyRoutedEventHandler);
        }
    }
}