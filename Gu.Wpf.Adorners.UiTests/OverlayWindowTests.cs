    ...
    public class OverlayWindowTests
    {
        ...
        public void BoundVisibility()
        {
            using (var app = Application.AttachOrLaunch(ExeFileName, WindowName))
            {
                ...
                ImageAssert.AreEqual(".\\Images\\OverlayWindow\\Bound_visibility_visible.png", button);

                window.FindToggleButton("IsVisibleButton").IsChecked = false;
                ImageAssert.AreEqual(".\\Images\\OverlayWindow\\Bound_visibility_not_visible.png", button);
            }
        }
        ...
        public void WhenSizeChanges()
        {
            using (var app = Application.AttachOrLaunch(ExeFileName, WindowName))
            {
                ...
                ImageAssert.AreEqual(".\\Images\\OverlayWindow\\Default_visibility.png", button);

                window.FindSlider("WidthSlider").Value = 100;
                ImageAssert.AreEqual(".\\Images\\OverlayWindow\\Default_visibility_width_100.png", button);
            }
        }
