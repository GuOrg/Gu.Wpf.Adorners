    ...
    public class TextBoxWindowTests
    {
        ...
        public void Default()
        {
            using (var app = Application.AttachOrLaunch(ExeFileName, WindowName))
            {
                ...
                {
                    ImageAssert.AreEqual(".\\Images\\Watermark\\TextBox\\Default_Win10.png", textBox);
                }
                else
                {
        ...
        public void DefaultWithZeroBorder()
        {
            using (var app = Application.AttachOrLaunch(ExeFileName, WindowName))
            {
                ...
                if (WindowsVersion.IsWindows10())
                {
                    ImageAssert.AreEqual(".\\Images\\Watermark\\TextBox\\Default_zero_border_Win10.png", textBox);
                }
                else
                {
                    Assert.Inconclusive($"No image for current windows version.");
