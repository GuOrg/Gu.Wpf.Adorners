    ...
    public static partial class WatermarkWindowTests
    {
        public class TextBox
        {
            ...
            public void WithDefaultWatermarkWhenNotFocused()
            {
                ...
                ImageAssert.AreEqual("Images\\WatermarkWindow\\TextBox\\Default_not_focused.png", textBox, TestImage.OnFail);
            }
            ...
            public void WithDefaultWatermarkWhenFocused()
            {
                ...
                var textBox = window.FindTextBox("TextBoxWithDefaultWatermark");
                textBox.Focus();
                ImageAssert.AreEqual("Images\\WatermarkWindow\\TextBox\\Default_focused.png", textBox, TestImage.OnFail);
            }
            ...
            public void WithDefaultWatermarkWhenNotEmpty()
            {
                ...
                ImageAssert.AreEqual("Images\\WatermarkWindow\\TextBox\\Default_not_empty.png", textBox, TestImage.OnFail);
            }
            ...
            public void WithWatermarkWithBoundText()
            {
                ...
                ImageAssert.AreEqual("Images\\WatermarkWindow\\TextBox\\Bound_text_AAA.png", textBox, TestImage.OnFail);
                window.FindTextBox("AdornerText").Text = "abc";
                window.FindButton("Lose focus").Invoke();
                Wait.For(TimeSpan.FromMilliseconds(50));
                ImageAssert.AreEqual("Images\\WatermarkWindow\\TextBox\\Bound_text_abc.png", textBox, TestImage.OnFail);
            }
            ...
            public void WithWatermarkWithInheritedFontSize()
            {
                ...
                ImageAssert.AreEqual("Images\\WatermarkWindow\\TextBox\\Inherited_font_size.png", textBox, TestImage.OnFail);
            }
            ...
            public void WithWatermarkWithExplicitTextStyle()
            {
                ...
                ImageAssert.AreEqual("Images\\WatermarkWindow\\TextBox\\Explicit_text_style.png", textBox, TestImage.OnFail);
            }
            ...
            public void WithInheritedTextStyle()
            {
                ...
                ImageAssert.AreEqual("Images\\WatermarkWindow\\TextBox\\Inherited_text_style.png", groupBox, TestImage.OnFail);
            }
            ...
            public void WithWatermarkVisibleWhenEmpty()
            {
                ...
                ImageAssert.AreEqual("Images\\WatermarkWindow\\TextBox\\Visible_when_empty_not_focused.png", textBox, TestImage.OnFail);
            }
            ...
            public void WithWatermarkVisibleWhenEmptyWhenFocused()
            {
                ...
                var textBox = window.FindTextBox("TextBoxWithWatermarkVisibleWhenEmpty");
                textBox.Focus();
                ImageAssert.AreEqual("Images\\WatermarkWindow\\TextBox\\Visible_when_empty_focused.png", textBox, TestImage.OnFail);
            }
            ...
            public void WithWatermarkVisibleWhenEmptyWhenNotEmpty()
            {
                ...
                textBox.Text = "abc";
                window.FindButton("Lose focus").Click();
                ImageAssert.AreEqual("Images\\WatermarkWindow\\TextBox\\Visible_when_empty_not_empty.png", textBox, TestImage.OnFail);
            }
            ...
            public void WithWatermarkVisibleWhenEmptyAndNotFocused()
            {
                ...
                ImageAssert.AreEqual("Images\\WatermarkWindow\\TextBox\\Visible_when_empty_and_not_focused_not_focused.png", textBox, TestImage.OnFail);
            }
            ...
            public void WithWatermarkVisibleWhenEmptyAndNotFocusedWhenFocused()
            {
                ...
                var textBox = window.FindTextBox("TextBoxWithWatermarkVisibleWhenEmptyAndNotFocused");
                textBox.Focus();
                ImageAssert.AreEqual("Images\\WatermarkWindow\\TextBox\\Visible_when_empty_and_not_focused_focused.png", textBox, TestImage.OnFail);
            }
            ...
            public void WithWatermarkVisibleWhenEmptyAndNotFocusedWhenNotEmpty()
            {
                ...
                textBox.Text = "abc";
                window.FindButton("Lose focus").Click();
                ImageAssert.AreEqual("Images\\WatermarkWindow\\TextBox\\Visible_when_empty_and_not_focused_not_empty.png", textBox, TestImage.OnFail);
            }
            ...
            public void WhenAdornedElementIs(string visibility)
            {
                ...
                ImageAssert.AreEqual("Images\\WatermarkWindow\\TextBox\\Default_not_focused.png", button, TestImage.OnFail);
